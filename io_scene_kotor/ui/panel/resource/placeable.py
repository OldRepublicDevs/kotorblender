...
class KB_PT_placeable(bpy.types.Panel):
    bl_label = "KotOR Placeable"
    ...
    def poll(cls, context: bpy.types.Context) -> bool:
        obj = context.object
        return is_mdl_root(obj) and obj.kb.classification == Classification.PLACEABLE
    ...
    def draw(self, context: bpy.types.Context) -> None:
        ...
        if obj is None:
            return
        layout.label(text="Placeable (UTP) — model root")
